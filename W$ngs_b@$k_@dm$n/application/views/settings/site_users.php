                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <!-- <i class="fa fa-edit"></i> --> site Users
                            </li>
                        </ol>
                        <!-- BreadCrumbs << -->
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary panel_primary_travels_cus">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-user"></i> Site Users</h3>
                            </div>
										 ...
										 {?>
		                  				 ...
		                  				 ?>
				                               ...
				                               <label class="col-lg-12">Name</label>
				                                 <input class="form-control col-lg-12" name="name" id="name" type="text" value="<?php echo set_value('name'); ?>">
				                                  <label class="err"><?php echo form_error('name');?></label>
				                            </div>
				                            
											<div class="form-group col-md-6">
				                               <label class="col-lg-12">User Name</label>
				                                 <input class="form-control col-lg-12" name="username" id="username" type="text" onchange="user_exist();" value="<?php echo set_value('username'); ?>">
				                             ...
				                             <div class="form-group col-md-6">
				                                ...
				                                <input class="form-control col-lg-12	" name="new_password" id="new_password" type="password" value="<?php echo set_value('new_password'); ?>">
				                               <label class="err"><?php echo form_error('new_password');?></label>
				                            </div>
				                            
				                             <div class="form-group col-md-6">
				                                <label class="col-lg-12"> Confirm Password</label>
				                                <input class="form-control col-lg-12	" name="confirm_password" id="confirm_password" type="password" value="<?php echo set_value('confirm_password'); ?>">
