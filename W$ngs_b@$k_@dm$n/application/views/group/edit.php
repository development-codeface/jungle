                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
							 ...
							 <li>
                                <i class="fa fa-dashboard"></i>  <a href="<?php echo base_url();?>group/list_group">Manage Group</a>
                            </li>
                            <li class="active">
                    ...
                    <div class="col-lg-6 ">
                        <div class="panel panel-primary panel_primary_travels_cus ">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-plus"></i> Edit Group </h3>
                            </div>
                                   	...
                                   	<div class="panel">
										 ...
										 {?>
		                  				 ...
		                  				 ?>
                                   				...
                                   				<form method="post" action="<?php echo base_url();?>group/update"  name="groups" id="groups">
				                            ...
				                            <div class="form-group col-md-12"><br/>	
				                                ...
				                                <input class="form-control col-lg-12" name="username" id="username" type="text" value="<?php echo $result[0]->username;?>" onkeyup="check_group_username();">
				                                <label class="err" id="email_exist"><?php echo form_error('username');?></label>
				                            </div>
											
				                            <div class="form-group col-md-12">
				                                <label class="col-lg-12">Password </label>
				                                <input class="form-control col-lg-12	" name="u_password" id="u_password" type="password" value="">
				                            </div>
