...
<form action="<?php echo base_url();?>report/amend_online" method="get" />
                            	...
                            	<div class="table-responsive" >
									...
									<tbody>
										...
										<tr>
											...
											<td><a  class="admin_delete_btn" href="<?php echo base_url('report/amend_update/'.$online_report->booking_number.'/'.$email);?>" onclick="return confirmationAmend()"><i class="fa fa-fw fa-trash"></i></a></td>
