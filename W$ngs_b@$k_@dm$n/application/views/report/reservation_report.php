                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-fw fa-table"></i> Booking Reservation Report
                            </li>
                        </ol>
                        <!-- BreadCrumbs << -->
                    </div>
...
<form action="<?php echo base_url();?>report/reservation" method="get" />
						...
						<div class="col-lg-12">
								<div class="row">
									...
									<div class="col-lg-2">
										<div class="form-group">
												<input class="col-lg-12 form-control" name="b_num" id="book_num" placeholder="Booking number" onkeypress="return onlyNumbers(event)"  value="<?php if(!empty($b_num)) { if($b_num != 'undefined') { echo $b_num; } }; ?>">
										</div>
									</div>
									<?php }
									else
									...
									<div class="col-lg-2">
										<div class="form-group">
												<input class="col-lg-12 form-control" name="b_num" id="book_num" placeholder="Booking number" onkeypress="return onlyNumbers(event)" onkeyup="get_reservation_online()" value="<?php if(!empty($b_num)) { if($b_num != 'undefined') { echo $b_num; } }; ?>">
										</div>
									</div>	
                            	...
                            	<div class="table-responsive" >
									...
									<tbody>
										...
										foreach($report as $online_report){ 
												...
												$total_amount = $online_report->payment+ $online_report->commision;
												$email = $online_report->email;
												?>
										<tr>
											<td><?php echo  $i++;?></td>
...
<script>
	function confirmationCancel(){
		...
		return confirm("Do yo want to cancel this booking");
	}
</script>