										...
										if(!empty($report))
										{
											...
											$i=1+$page;
											 foreach($report as $online_report){
												...
												echo $total_amount = $online_report->payment+$commision_price->commision;
												?>
										<tr>
											<td><?php echo  $i++;?></td>
											...
											<td><i class="fa fa-inr"></i> <?php echo $total_amount; if($online_report -> coupon_amount) echo ' (- '.$online_report -> coupon_amount.')';?></td>
										</tr>
										<?php
										}
										}
