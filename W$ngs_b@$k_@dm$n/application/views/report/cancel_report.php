                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-fw fa-table"></i> Booking Cancel Report
                            </li>
                        </ol>
                        <!-- BreadCrumbs << -->
                    </div>
...
<form action="<?php echo base_url();?>report/cancel_online" method="get" />
                            	...
                            	<div class="table-responsive" >
									...
									<tbody>
										...
										<tr>
											...
											<td><a  class="admin_delete_btn" href="<?php echo base_url('report/cancel_update/'.$online_report->booking_number.'/'.$email);?>" onclick="return confirmationCancel()"><i class="fa fa-fw fa-trash"></i></a></td>
										...
										{?>
										 <tr class="active text-center hgt_td"><td colspan="7" class="text-center">No results found.</td></tr> 
										<?php }?>
									</tbody>
		                            </table>
		                        </div>
