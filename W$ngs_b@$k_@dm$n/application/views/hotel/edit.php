                ...
                <div class="list-group">
                  <div class="panel">
					...
					<div class="form-group col-lg-6" >
							  ...
							  <input class="col-lg-12 form-control " type="file" name="logo"> <span style="color : red;">Logo size - 200 x 100 (Width x Height)</span>
							</div>
                      ...
                      <select class="col-lg-12 form-control " name="star_rating" id="star_rating">
                          <option value="0" <?php if($result->star_rating == 0){ ?> selected="selected"<?php }?>>Individual</option>
                          <option value="1" <?php if($result->star_rating == 1){ ?> selected="selected"<?php }?>>1</option>
                      ...
                      <select class="col-lg-12 form-control" name="group_id" id="group_id">
						   ...
						   {
							   ?>
							   <option value="<?php echo $group_name->id;?>" <?php if($result->group_id==$group_name->id){?> selected="selected"<?php }?>><?php echo $group_name->name;?></option>
							   <?php
						   }
							?>
						</select>
                    ...
                    <div class="form-group col-lg-6">
                      <label class="col-lg-12 subcatagorylable">Catagory</label>
					...
					<div class="form-group col-lg-6">
                      ...
                      <input class="col-lg-12 form-control" name="destination"  value="<?php echo $result->destination;?>" id="destination">
                    </div>
                      ...
                      <div class="form-group col-lg-12 remove_p_tax_block_cus ">
                      	  ...
                      	  <input type="hidden" name="hotel_id[]" value="<?php echo $tax_data->id;?>" />
						     <div class="form-group col-lg-6  cus_p_r_4">
	                      	<div class="col-lg-6">  
	                      		 <input class="col-lg-12 form-control" name="seasonal[]" readonly=""  value="<?php echo $tax_data->tax_type;?>"> 
	                       </div>
	                       <div class="col-lg-6"> 
				  ...
				  <div class="form-group col-lg-12 remove_p_tax_block_cus">
							...
							<?php
						     ...
						     <div class="form-group col-lg-6  cus_p_r_4">
	                      	<div class="col-lg-6">  
	                      		 <input class="col-lg-12 form-control" name="off_seasonal[]" readonly="" value="<?php echo $tax_off_data->tax_type;?>"> 
	                       </div>
	                       <div class="col-lg-6"> 
