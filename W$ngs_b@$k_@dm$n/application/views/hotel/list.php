		                            ...
		                            <table class="table table-bordered table-hover table-striped">
		                                ...
		                                if(!empty($results)){
		                                    ...
		                                    <tr <?php if($i%2==0){ echo 'class="active"';} else{ echo 'class="success"';}?>>
		                                        ...
		                                        <td><a href="<?php echo base_url('hotel/view_access/'.$result->sub_category_id.'/'.$result->id);?>">View Access</a></td>
		                                        <td><a href="#" onclick="aff(<?php echo $result->id;?>); return false;" data-toggle="modal" data-target="#myLink">Link</a>
												</td>
		                                    </tr>
		                                <?php $i++;}}
		                                else{
