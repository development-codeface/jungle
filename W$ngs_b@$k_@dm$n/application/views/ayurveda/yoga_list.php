            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-fw fa-table"></i> Manage Yoga
                            </li>
                        </ol>
                        <!-- BreadCrumbs << -->
                    </div>
                ...
                <!-- Page Heading << -->
				  ...
				  <div class=" text-right">
				  	<p>
				  	<a class="btn btn-success" href="<?php echo base_url('ayurveda/add/yoga');?>"><span><i class="fa fa-plus-square"></i></span>  Add Yoga</a>
