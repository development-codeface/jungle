						...
						<div class="row panel">
		                            	<form>
				                               ...
				                               <select name="hotelid" class="form-control" id="hotelid">
									                ...
									                <div class="col-lg-2"><span id="sandbox-container-tr1">
						                                <input class="col-lg-10 form-control" value="<?php if(!empty($from)) echo date_format(date_create_from_format('Y-m-d', $from), 'd-m-Y'); ?>" placeholder="From Date" name='from_date' id='from_date' ></span>
									                </div>
									          
		                               		
									                <div class="col-lg-2"><span id="sandbox-container-tr2">
						                                <input class="col-lg-10 form-control" value="<?php if(!empty($to)) echo date_format(date_create_from_format('Y-m-d', $to), 'd-m-Y'); ?>"  placeholder="To Date" name='to_date' id='to_date' ></span>
									                </div>
													<div class="col-lg-2">
													<div class="form-group ">
														<input class="col-lg-10 btn btn-success" name="submit" id="" type="submit" value="Submit">
													</div>
											</div>	
						                    </div>
		                            ...
		                            <table class="table table-bordered table-hover" id="commision">
		                                ...
		                                <tbody>
											...
											foreach ($result as $detail) {
													...
													?>
												<tr>
												 <td><?php echo $booking_details[0]->hotel;?></td>
		                                        ...
		                                        <td colspan="6">
			                                        ...
			                                        <th>Total Commision</th>
														...
														-> row();
															...
															$comm = ($booking -> commision / $booking -> number_of_rooms) * $booking->number_of_rooms;
													...
													?>
		                                        		<tr>
		                                        			...
		                                        			<?php } ?>
		                                        			<?php if(empty($z)) {?>
		                                        			<td rowspan="<?php echo count($booking_details); ?>"><?php echo $commision_price->commision; $z = 1;?></td>
		                                        			<?php } ?>
		                                        		</tr>
		                                        		<?php
														}
