                    ...
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="panel panel-primary panel_primary_travels_cus ">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-plus"></i> Update Coupon</h3>
                            </div>
                            <div class="panel-body">
                                <div class="list-group">
									...
									<input autocomplete="off" value="<?php echo date_format(date_create_from_format('Y-m-d', $cpn -> valid_from), 'd-m-Y'); ?>" class="form-control col-lg-12" name="valid_from" id="valid_from">
				                                  <?php echo form_error('valid_from');?>
								</span></div>
				                              <div class="form-group col-md-6">
				                                <label class="col-lg-12">Valid to</label><span id="sandbox-container-to3">
									<input autocomplete="off" value="<?php echo date_format(date_create_from_format('Y-m-d', $cpn -> valid_to), 'd-m-Y'); ?>" class="form-control col-lg-12" name="valid_to" id="valid_to">
				                                  <?php echo form_error('valid_to');?>
								</span></div>
												
				                            <div class="form-group col-md-6">
				                                <label class="col-lg-12">Coupon Code</label>
				                                 <input autocomplete="off" class="form-control col-lg-12" name="c_code" id="c_code" type="text" value="<?php echo $cpn -> coupon_code; ?>">
				                                  <?php echo form_error('c_code');?>
				                            </div>
				                              <div class="form-group col-md-6">
				                                <label class="col-lg-12">Offer</label>
				                                 <input autocomplete="off" onkeypress="return onlyNumbers(event)" value="<?php echo $cpn -> offer; ?>" placeholder="offer in %" class="form-control col-lg-12" name="offer" id="offer" type="text">
				                              ...
				                              <div class="form-group col-md-6">
				                                <label class="col-lg-12">Validity Type</label>
												 ...
												 <option value="0" <?php if($cpn -> type == 0) echo 'selected'; ?>>check-in/out date</option>
												 <option value="1" <?php if($cpn -> type == 1) echo 'selected'; ?>>booking date</option>
												 </select>
				                            </div>
				                              <div class="form-group col-md-6">
				                                <label class="col-lg-12">Min. amount</label>
				                                 <input autocomplete="off" onkeypress="return onlyNumbers(event)" value="<?php echo $cpn -> min_amount; ?>" class="form-control col-lg-12" name="min_amount" id="min_amount" type="text">
