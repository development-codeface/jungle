...
$route['ayurveda/search_det'] = "ayurveda/search_det";
$route['hotel-packages/search_det'] = "ayurveda/search_det";
...
$route['hotels/(:any)-in-(:any)'] = "hotels/destination/$1/$2";
$route['homestays/(:any)-in-(:any)'] = "hotels/destination/$1/$2";
$route['apartments/(:any)-in-(:any)'] = "hotels/destination/$1/$2";

$route['hotel-packages/packages-in-(:any)'] = "ayurveda/destination/$1";
