...
If (isset($_POST["additionalCharges"])) {
       ...
       if ($hash != $posted_hash) {
          ...
          $msg.= "<h5>If you wish to amend/cancel this booking, please login to your account at <a href='http://www.bookingwings.com/'>Bookingwings.com</a></h5>";
...
////  PayU Success end ////
		...
		$available_rooms = array_values(array_diff($id1,$id2));
			...
			for($k=0;$k<$data['number_of_rooms'];$k++)
			{
				...
				//$this->load->view('main/res_checkout_email', $mydata);
