...
<?php  
    ...
    <div id="result-wrapper" style="padding-bottom:0px;">
						...
						?>
									...
									$dec_hotel=str_replace(array('-', '_', '~'), array('+', '/', '='),$this->uri->segment(3));
									 $hotelid=$this->encrypt->decode($dec_hotel);
										...
										?> </span>
										<a href="#section3" class="btn btn-primary btn-sm pull-right select_padding select-but font-butt"> SELECT ROO </a>
							  ...
							  <div class="container-fluid" id="sticky_navbar_inner">
							    ...
							    <div class="collapse navbar-collapse hotelDetailTab" id="bs-example-navbar-collapse-1">
							      <ul class="nav navbar-nav">
							        ...
							        <li><a class="hiden_mneu3" href="#section3">Available Tents</a></li>
...
<div class="col-md-12  table_rooms_list">
	...
	<?php if(!empty($room_setting_detail))
	 ...
	 <div class="s_show_morecus roomMoredet" data-toggle="modal" data-target="#myModal_room<?php echo $room->id ?>"><i class="fa fa-info-circle" aria-hidden="true"></i>  Tent Detail</div>
			  <!-- Modal -->
	...
	<?Php } ?>
				  ...
				  <div class="facilitiesOuter">
					...
					<?php if(!empty($fac_room->city_view)) {?>
									...
									<div class="col-md-4 col-xs-6">
										<span class="room_faci"><i class="fa fa-check"></i> Interconnected Tents</span>
									</div>
										...
										<span class="info label label-danger">Room Not Available</span>
											...
											else
											{
								      		...
								      		$room_count=$this->Room_detail_model->rooms_count($details->id,$room->id);
												...
												{
												?>
												<span class="info label label-danger">Tents Available</span>
											...
											<?php 
												...
												{
													?>
													<span class="info label label-danger">Tents Not Available</span>
													<?php
												}
											}?>		
