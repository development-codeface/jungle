			...
			<div class="row">
				...
				<form class="coontainer-fluid search_block" method="get" role="form" action="<?php echo base_url().$sub_cat; ?>/detail-search">
					...
					<div class="modSearchOuter">
						...
						<input type="hidden" name="pack_destination" id="destination" value="<?php if(!empty($this->session->userdata['datahere']['package_destination'])){ echo $this->session->userdata['datahere']['package_destination']; } ?>"  />
