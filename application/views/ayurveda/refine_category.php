...
<div class="col-md-3">
					<div class="search_filter search_filter_cus_hotels">
						...
						<span class="block_head">Facilities</span>
								...
								$fa5	= in_array("bar ", $fac);
								$fa6	= in_array("satellite_channels ", $fac);
								}
								?>	
						<div class="block">
							<div>	
							...
							<span class="inp"><input id="option1_cus_hotel11" type="checkbox" name="facilities" value="free_fFitness_centre " onclick="ayur_catchStar(this.value)" <?php if(!empty($fa4)) echo 'checked' ?>/><label class="checkbox checkbox_det" for="option1_cus_hotel11">
							...
							<div>	
								<span class="inp"><input id="option1_cus_hotel001" type="checkbox" name="facilities" value="bar" onclick="ayur_catchStar(this.value)" <?php if(!empty($fa5)) echo 'checked' ?>/><label class="checkbox checkbox_det" for="option1_cus_hotel001">
									<i ></i>Bar</label>
								</span>
								<!--<span class="pull-right count">23</span>-->
							</div>
							<div>	
								<span class="inp"><input id="option1_cus_hotel002" type="checkbox" name="facilities" value="satellite_channels " onclick="ayur_catchStar(this.value)" <?php if(!empty($fa6)) echo 'checked' ?> /><label class="checkbox checkbox_det" for="option1_cus_hotel002">
        ...
        <div class="modal-body">
        	<div class="search_filter_cus_hotels_block1">
						...
						<div class="block modell-block">
								...
								$star0		= in_array(0, $star_rating);								} ?>
							<div>
								<span class="inp"><input type="checkbox" name="star_mob" onclick="ayur_catchStarMob(this.value)" value="5" <?php if(!empty($star5)) echo 'checked' ?> /></span>
								<span class="star-rating"> 
									<span class="fa fa-star gold" data-rating="1" value="1" ></span>
									<span class="fa fa-star gold" data-rating="2" value="2" ></span>
									<span class="fa fa-star gold" data-rating="3" value="3" ></span>
							...
							<div>	
								<span class="inp"><input type="checkbox" name="star_mob" onclick="ayur_catchStarMob(this.value)" value="4" <?php if(!empty($star4)) echo 'checked' ?> /></span>
								<span class="star-rating"> 
									<span class="fa fa-star gold" data-rating="1"></span>
									<span class="fa fa-star gold" data-rating="2"></span>
									<span class="fa fa-star gold" data-rating="3"></span>
							...
							<div>	
								<span class="inp"><input type="checkbox" name="star_mob" onclick="ayur_catchStarMob(this.value)" value="3" <?php if(!empty($star3)) echo 'checked' ?> /></span>
								<span class="star-rating"> 
									<span class="fa fa-star gold" data-rating="1"></span>
									<span class="fa fa-star gold" data-rating="2"></span>
									<span class="fa fa-star gold" data-rating="3"></span>
							...
							<div>	
								<span class="inp"><input type="checkbox" name="star_mob" onclick="ayur_catchStarMob(this.value)" value="2" <?php if(!empty($star2)) echo 'checked' ?> /></span>
								<span class="star-rating"> 
									<span class="fa fa-star gold" data-rating="1"></span>
									<span class="fa fa-star gold" data-rating="2"></span>
									<span class="fa fa-star-o" data-rating="3"></span>
							...
							<div>	
								<span class="inp"><input type="checkbox" name="star_mob" onclick="ayur_catchStarMob(this.value)" value="1" <?php if(!empty($star1)) echo 'checked' ?> /></span>
								<span class="star-rating"> 
									<span class="fa fa-star gold" data-rating="1"></span>
									<span class="fa fa-star-o" data-rating="2"></span>
									<span class="fa fa-star-o" data-rating="3"></span>
								...
								<div>	
								<span class="inp"><input type="checkbox" name="star_mob" onclick="ayur_catchStarMob(this.value)" value="0" <?php if(!empty($star0)) echo 'checked' ?> /></span>
								<span class="star-rating"> 
									<span class="fa fa-star-o" data-rating="1"></span>
									<span class="fa fa-star-o" data-rating="2"></span>
									<span class="fa fa-star-o" data-rating="3"></span>
						...
						<div class="block modell-block">
							<div>	
								<span class="inp"><input id="option1_cus_hotel08"   type="checkbox" name="facilities_mob" value="free_parking" onclick="ayur_catchStarMob(this.value)" <?php if(!empty($fa1)) echo 'checked' ?> /><label class="checkbox checkbox_det" for="option1_cus_hotel08">
									<i ></i>Free Parking Area</label>
								</span>
							</div>
							<div>	
								<span class="inp"><input id="option1_cus_hotel09"  type="checkbox" name="facilities_mob" value="free_wifi" onclick="ayur_catchStarMob(this.value)" <?php if(!empty($fa2)) echo 'checked' ?> /><label class="checkbox checkbox_det" for="option1_cus_hotel09">
									<i ></i>Free Internet service</label>
								</span>
							</div>
							<div>	
								<span class="inp"><input id="option1_cus_hotel010"  type="checkbox" name="facilities_mob" value="restaurant" onclick="ayur_catchStarMob(this.value)" <?php if(!empty($fa3)) echo 'checked' ?> /><label class="checkbox checkbox_det" for="option1_cus_hotel010">
									<i ></i>Restaurant</label>
								</span>
							</div>
							<div>	
							
							<span class="inp"><input id="option1_cus_hotel011" type="checkbox" name="facilities_mob" value="free_fFitness_centre " onclick="ayur_catchStarMob(this.value)" <?php if(!empty($fa4)) echo 'checked' ?>/><label class="checkbox checkbox_det" for="option1_cus_hotel011">
									<i ></i>Fitness Center</label>
								</span>
							...
							<div>	
								<span class="inp"><input id="option1_cus_hotel0001" type="checkbox" name="facilities_mob" value="bar" onclick="ayur_catchStarMob(this.value)" <?php if(!empty($fa5)) echo 'checked' ?>/><label class="checkbox checkbox_det" for="option1_cus_hotel0001">
									<i ></i>Bar</label>
								</span>
								<!--<span class="pull-right count">23</span>-->
							</div>
							<div>	
								<span class="inp"><input id="option1_cus_hotel0002" type="checkbox" name="facilities_mob" value="satellite_channels " onclick="ayur_catchStarMob(this.value)" <?php if(!empty($fa6)) echo 'checked' ?> /><label class="checkbox checkbox_det" for="option1_cus_hotel0002">
									<i ></i>Satelite Channels</label>
								</span>
								<!--<span class="pull-right count">23</span>-->
							</div>
						...
						<div class="search_filter_cus_hotels_block3">
							...
							<div class="block modell-block">
									...
									<input class="span2  hotel_name_cus_input_box toprTop" value="<?php if(!empty($_GET['checkedArray_hotelName'])) {echo $_GET['checkedArray_hotelName'][0]; } ?>" id="inputIcon_mob"  type="text" onkeyup="ayur_catchStarMob()" placeholder="Type Here">
						...
						<div class="block modell-block">
							<div>	
								<span class="inp"><input id="option1_cus_hotel004" type="checkbox" name="location_mob" onclick="ayur_catchStarMob(this.value)" <?php if(!empty($loc1)) echo 'checked' ?> value="Thiruvananthapuram" /><label class="checkbox checkbox_det" for="option1_cus_hotel004">
									<i ></i>Thiruvananthapuram</label>
								</span>
							</div>
							<div>	
								<span class="inp"><input id="option1_cus_hotel005" type="checkbox" name="location_mob" onclick="ayur_catchStarMob(this.value)" <?php if(!empty($loc2)) echo 'checked' ?> value="Kovalam" /><label class="checkbox checkbox_det" for="option1_cus_hotel005">
									<i ></i>Kovalam</label>
								</span>
							</div>
							<div>	
								<span class="inp"><input id="option1_cus_hotel006" type="checkbox" name="location_mob" onclick="ayur_catchStarMob(this.value)" <?php if(!empty($loc3)) echo 'checked' ?>  value="Munnar" /><label class="checkbox checkbox_det" for="option1_cus_hotel006">
									<i ></i>Munnar</label>
								</span>
							</div>
							<div>	
								<span class="inp"><input id="option1_cus_hotel007" type="checkbox" name="location_mob" onclick="ayur_catchStarMob(this.value)" <?php if(!empty($loc4)) echo 'checked' ?> value="Cochin" /><label class="checkbox checkbox_det" for="option1_cus_hotel007">
									<i ></i>Cochin</label>
								</span>
							</div>
						</div>
