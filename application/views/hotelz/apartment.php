...
<head>
    ...
    <meta name="description" content="Get great deals for apartment rentals for holiday stay with modern amenities and great comfort anywhere in Kerala, best online holiday apartment rentals.">
    <meta name="author" content="">


    <title> Holiday Apartment Rentals – Apartment for Stay in Kerala </title>
...
?>
    ...
    <div id="page-wrapper">
    	...
    	<div id="search-banner" style="background: url(<?php echo base_url();?>img/apartments.jpg) no-repeat center center; background-size: cover;">
...
<br>
				...
				<div class="row toper-row">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 search_options">
						...
						<form role="form" method="get"  class="sear_cus"  name="search_form" action="<?php echo base_url(); ?>apartments/search_list">														
							<div class="container-fluid bg-search">					
								<!-- Search Input >> -->
								<div class="col-md-8">
								  <div class="form-group apartc">
								 ...
								 -->
								<input id="hidden-search" name="hidden-search"  autocomplete="off"  class="form-control auto" placeholder="City, Area or Apartment name"  />
	...
	<!-- <h3>Top Destinations</h3> -->
		...
		<div class="carousel-inner" role="listbox">
			...
			<div class="item active">
				...
				<a href="<?php base_url();?>apartments/apartments-in-Cochin">
				<div class="col-md-4 col-md-5 col-sm-6 top_des">
					...
					<a href="<?php echo base_url();?>apartments/apartments-in-Munnar">
				<div class="col-md-6 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8  pull-left">
					<h4>Munnar</h4>
					<h5>Mountain town surrounded by tea estates.</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'Munnar');?> Properties</h6>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4  pull-right">
				...
				<a href="<?php echo base_url();?>apartments/apartments-in-Thekkady">
				<div class="col-md-6 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8  pull-left">
					<h4>Thekkady</h4>
					<h5>Scenic game & ecotourism reserve</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'Thekkady');?> Properties</h6>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4  pull-right">
				...
				<a href="<?php base_url();?>apartments/apartments-in-Kumarakom">
				<div class="col-md-4 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8  pull-left">
					<h4>Kumarakom</h4>
					<h5>Lakes, boathouses, honeymoon, lagoons</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'kumarakom');?> Properties</h6>
					</div>
					<div class="col-md-4  col-sm-4 col-xs-4 pull-right">
				...
				<a href="<?php base_url();?>apartments/apartments-in-Alappuzha">
				<div class="col-md-6 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8 pull-left">
					<h4>Alappuzha</h4>
					<h5>Backwater cruises & Alappuzha Beach</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'alappuzha');?> Properties</h6>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4  pull-right">
				...
				<a href="<?php echo base_url();?>apartments/apartments-in-Kovalam">
				<div class="col-md-4 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8  pull-left">
					<h4>Kovalam</h4>
					<h5>Beaches, surfing, seaside resorts, yoga, honeymoon</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'kovalam');?> Properties</h6>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4 pull-right">
				...
				<a href="<?php echo base_url();?>apartments/apartments-in-Varkala">
				<div class="col-md-6 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8  pull-left">
					<h4>Varkala</h4>
					<h5>Beaches, cliffs, yoga, temples, surfing.</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'Varkala');?> Properties</h6>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4  pull-right">
				...
				<a href="<?php echo base_url();?>apartments/apartments-in-Wayanad">
				<div class="col-md-6 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8  pull-left">
					<h4>Wayanad</h4>
					<h5>Honeymoon, gardens, romantic place</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'Wayanad');?> Properties</h6>
					</div>
					<div class="col-md-4  col-sm-4 col-xs-4 pull-right">
				...
				<a href="<?php echo base_url();?>apartments/apartments-in-Bekal">
				<div class="col-md-6 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8 pull-left">
					<h4>Bekal</h4>
					<h5>Beaches, temples, shopping</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'Bekal');?> Properties</h6>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4  pull-right">
				...
				<a href="<?php echo base_url();?>apartments/apartments-in-Kozhikode">
				<div class="col-md-4 col-md-5 col-sm-6 top_des">
					<div class="col-md-8  col-sm-8 col-xs-8 pull-left">
					<h4>Kozhikode</h4>
					<h5>Beaches, temples, shopping, architecture, honeymoon</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'Kozhikode');?> Properties</h6>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4 pull-right">
				...
				<a href="<?php echo base_url();?>apartments/apartments-in-Thrissur">
				<div class="col-md-4 col-md-5 col-sm-6 top_des">
					<div class="col-md-8  col-sm-8 col-xs-8 pull-left">
					<h4>Thrissur</h4>
					<h5>Temples, elephants, zoos, churches</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'Thrissur');?> Properties</h6>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4 pull-right">
			...
			<a href="<?php echo base_url();?>apartments/apartments-in-Kanyakumari">
				<div class="col-md-4 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8  pull-left">
					<h4>kanyakumari</h4>
					<h5>Beache, Temple, seaside resorts</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'kanyakumari');?> Properties</h6>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4  pull-right">
			...
			<div class="item">
				...
				<a href="<?php echo base_url();?>apartments/apartments-in-Thalassery">
				<div class="col-md-6 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8  pull-left">
					<h4>Thalassery</h4>
					<h5>Temples, beaches, circuses, history</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'Thalassery');?> Properties</h6>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4  pull-right">
				<img src="<?php echo base_url();?>img/slider/31.jpg">
							...
							<a href="<?php echo base_url();?>apartments/apartments-in-Thiruvananthapuram">
				<div class="col-md-4 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8  pull-left">
					<h4>Thiruvananthapuram</h4>
					<h5>Travancore palaces, fine art & beaches</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'Thiruvananthapuram');?> Properties</h6>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4  pull-right">
				...
				<a href="<?php echo base_url();?>apartments/apartments-in-Kollam">
				<div class="col-md-6 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8  pull-left">
					<h4>Kollam</h4>
					<h5>Beaches, temples, churches, shopping, honeymoon</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'Kollam');?> Properties</h6>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4  pull-right">
				...
				<a href="<?php base_url();?>apartments/apartments-in-Kannur">
				<div class="col-md-6 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8  pull-left">
					<h4>Kannur</h4>
					<h5>Beaches</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'kannur');?> Properties</h6>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4  pull-right">
				...
				<a href="<?php echo base_url();?>apartments/apartments-in-Marayoor">
				<div class="col-md-6 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8  pull-left">
					<h4>Marayoor</h4>
					<h5>Forests, waterfalls, nature</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'Marayoor');?> Properties</h6>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4  pull-right">
				<img src="<?php echo base_url();?>img/slider/40.jpg">
					...
					<a href="<?php echo base_url();?>apartments/apartments-in-Chalakudy">
				<div class="col-md-6 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8  pull-left">
					<h4>Chalakudy</h4>
					<h5>Waterfalls, temples, churches, rivers, forests</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'Chalakudy');?> Properties</h6>
					</div>
					<div class="col-md-4  col-sm-4 col-xs-4 pull-right">
			...
			<a href="<?php echo base_url();?>apartments/apartments-in-Malampuzha">
				<div class="col-md-6 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8  pull-left">
					<h4>Malampuzha</h4>
					<h5>Gardens, water reservoir, aquariums, amusement parks</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'Malampuzha');?> Properties</h6>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4  pull-right">
				...
				<a href="<?php echo base_url();?>apartments/apartments-in-Kasaragod">
				<div class="col-md-6 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8  pull-left">
					<h4>Kasaragod</h4>
					<h5>Beaches, temples, shopping</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'Kasaragod');?> Properties</h6>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4  pull-right">
			...
			<a href="<?php echo base_url();?>apartments/apartments-in-Palakkad">
				<div class="col-md-6 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8  pull-left">
					<h4>Palakkad</h4>
					<h5>Temples, elephants, honeymoon</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'Palakkad');?> Properties</h6>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4  pull-right">
				...
				<!--<a href="<?php echo base_url();?>apartments/search_list?hidden-search=Gavi&destination=Gavi&category=4&check_in=&check_out=&mem_type=1&adults%5B%5D=1&childrens%5B%5D=0&prev-childs-1%5B%5D=0">
				
				<div class="col-md-6 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 pull-left">
					<h4>Gavi, Kerala</h4>
					<h5>Ecotourism, forests, safaris, waterfalls, elephants.</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'Gavi');?> Properties</h6>
					</div>
				...
				<a href="<?php echo base_url();?>apartments/apartments-in-Vagamon">
				
				<div class="col-md-6 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8  pull-left">
					<h4>Vagamon</h4>
					<h5>Paragliding, honeymoon</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'Vagamon');?> Properties</h6>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4  pull-right">
				...
				<a href="<?php echo base_url();?>apartments/apartments-in-Kottayam">
				<div class="col-md-6 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8  pull-left">
					<h4>Kottayam</h4>
					<h5>Churches, temples, honeymoon</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'Kottayam');?> Properties</h6>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4  pull-right">
				...
				<a href="<?php echo base_url();?>apartments/apartments-in-Guruvayur">
				<div class="col-md-6 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8  pull-left">
					<h4>Guruvayur</h4>
					<h5>Elephants, temples</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'Guruvayur');?> Properties</h6>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4  pull-right">
			...
			<a href="<?php echo base_url();?>apartments/apartments-in-Poovar">
				<div class="col-md-6 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8  pull-left">
					<h4>Poovar</h4>
					<h5>Beaches, estuaries, honeymoon, lakes</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'Poovar');?> Properties</h6>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4  pull-right">
				...
				<a href="<?php echo base_url();?>apartments/apartments-in-Malappuram">
				
				<div class="col-md-6 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8  pull-left">
					<h4>Malappuram</h4>
					<h5>Forests, temples, museums</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'Malappuram');?> Properties</h6>
					</div>
					<div class="col-md-4  col-sm-4 col-xs-4 pull-right">
					<img src="<?php echo base_url();?>img/slider/23.jpg">
						...
						<a href="<?php echo base_url();?>apartments/apartments-in-Thodupuzha">
				
				<div class="col-md-6 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8  pull-left">
					<h4>Thodupuzha</h4>
					<h5>Temples, churches, waterfalls, fashion</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'Thodupuzha');?> Properties</h6>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4  pull-right">
				...
				<a href="<?php echo base_url();?>apartments/apartments-in-Aluva">
				<div class="col-md-6 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8  pull-left">
					<h4>Aluva</h4>
					<h5>Temples, palaces, rivers, churches</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'Aluva');?> Properties</h6>
					</div>
					<div class="col-md-4  col-sm-4 col-xs-4 pull-right">
				...
				<a href="<?php echo base_url();?>apartments/apartments-in-Athirappilly">
				<div class="col-md-6 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8 pull-left">
					<h4>Athirappilly</h4>
					<h5>Waterfalls, forests, honeymoon, rainforests, rivers</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'Athirappilly');?> Properties</h6>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4  pull-right">
				...
				<a href="<?php echo base_url();?>apartments/apartments-in-Ernakulam">
				<div class="col-md-6 col-md-5 col-sm-6 top_des">
					<div class="col-md-8  col-sm-8 col-xs-8 pull-left">
					<h4>Ernakulam</h4>
					<h5>Temples, churches</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'Ernakulam');?> Properties</h6>
					</div>
					<div class="col-md-4  col-sm-4 col-xs-4 pull-right">
				...
				<a href="<?php echo base_url();?>apartments/apartments-in-Angamaly">
				<div class="col-md-6 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8  pull-left">
					<h4>Angamaly</h4>
					<h5>Churches, basilica, history</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'Angamaly');?> Properties</h6>
					</div>
					<div class="col-md-4  col-sm-4 col-xs-4 pull-right">
				...
				<a href="<?php echo base_url();?>apartments/apartments-in-Ponmudi">
				<div class="col-md-6 col-md-5 col-sm-6 top_des">
					<div class="col-md-8 col-sm-8 col-xs-8 pull-left">
					<h4>Ponmudi</h4>
					<h5>Waterfalls, backpacking, forests, mountains, frogs</h5>
					<h6><?php echo $this->Hotels_model->destination_count($cat_id,$res_cat_id,'Ponmudi');?> Properties</h6>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-4 pull-right">
		...
		<div class="container">	
			...
			<!---<div class="row wrapper-row">
		    	...
		    	<div class="col-sm-6 col-md-3 new_thumbnail">
		    		<a href="<?php echo base_url();?>apartments/detail/<?php echo $enc_id; ?>">
				        <div class="thumbnail">
					...
					$enc_id = str_replace(array('+', '/', '='), array('-', '_', '~'), $enc_id); 
							...
							<div class="home_reviews">
					            ...
					            <span class="fa fa-star-o"></span> <?php } ?>
									...
									<a class="hotel_name" href="<?php echo base_url;?>apartments/detail<?php echo $enc_id;?>"><?php echo $review->hotel; ?></a>
