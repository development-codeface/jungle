...
<img style="height: 100px;"src="<?php echo base_url();?><?php print_r($booking_details->logo_img); ?>">
</div>
...
?>
 ...
 <ul>
 <li class="col-md-12 li_c" style="display: inline-block; width: 450px;background: hsl(0, 0%, 100%) none repeat scroll 0 0;border: 2px solid hsl(0, 0%, 93%);padding: 0;  list-style: outside none none;
  margin-bottom: 7px;"> <span class="col-md-6 cus-dt" style="font-family: lato;padding: 7px;"> Name</span><span class="col-md-6 cus-dt2" style="padding: 7px; font-family: lato;font-weight: bolder;"><?php echo $booking_details->name ?> </span> </li>
...
<td style=" border: 1px solid #ccc;padding: 10px;"><?php echo $booking_details->tax;?></td> 
...
<td style=" border: 1px solid #ccc;padding: 10px;"><?php echo number_format($booking_details->payment + $booking_details->commision,2); ?></td> 
...
If you wish to amend/cancel this booking, please login to your account at <a href="http://www.bookingwings.com/">Bookingwings.com</a>
</p>
...
<p class="price" style="  background: #f4f4f4;font-family: lato;font-size: 27px;font-weight: bolder;padding: 58px 9px;text-align: center;margin:0px;">INR. <?php echo number_format($booking_details->payment + $booking_details->commision,2);?></p>
</div>
...
<div class="email_f_foot" style=" background: #216393; color: #fff;padding: 10px;">
 <span class="addres_f" style="  font-family: helvetica;font-size: 13px;font-weight: 500;margin-bottom: 0; margin-top: 20px;  text-align: center;"><?php print_r($hotel->address); ?></span> 
