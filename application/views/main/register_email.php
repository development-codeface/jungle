...
<h6 class="email_user_h" style="color: #44494C;font-family: roboto;font-size: 25px;text-align: center;margin:15px 0px;">Registration Submitted Successfully...</h6>

<p class="email_user_n" style="font-family: roboto;font-weight: 500;">Hi,</p>
<p class="email_cntnt" style="font-family: raleway;font-size: 13px;font-weight: 500;line-height: 25px;">Thanks for registering as a user at Bookingwings.com. Your login details are below: 
 </p>
 <p class="email_cntnt" style="font-family: raleway;font-size: 13px;font-weight: 500;line-height: 25px;">Username: <?php print_r($email);?>
 </p>
 <?php
 if(!empty($password))
 {?>
 
 <p class="email_cntnt" style="font-family: raleway;font-size: 13px;font-weight: 500;line-height: 25px;">Password : <?php print_r($password);?>
 </p>
<?php } ?>
...
<p class="fo_c">
Please make sure to update your password on first login. 
<br/>
Thanks,
<br>
