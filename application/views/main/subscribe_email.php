...
<h6 class="email_user_h" style="color: #44494C;font-family: roboto;font-size: 25px;text-align: center;margin:15px 0px;">Newsletter Subscribed..</h6>

<p class="email_user_n" style="font-family: roboto;font-weight: 500;">Hi,</p>
<p class="email_cntnt" style="font-family: raleway;font-size: 13px;font-weight: 500;line-height: 25px;">Welcome to BookingWings! 
 </p>
 <p class="email_cntnt" style="font-family: raleway;font-size: 13px;font-weight: 500;line-height: 25px;">Thank you for subscribing to our newsletter.
 </p>
