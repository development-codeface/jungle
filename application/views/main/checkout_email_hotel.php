...
<td style=" border: 1px solid #ccc;background-color: #fff;padding: 10px;"><?php if($category=='hotel'){?>
									...
									<?php }
									  ...
									  echo $each_room_price= $room_detail->room_rate ; ?> </td> 
...
<td style=" border: 1px solid #ccc;padding: 10px;"><?php echo number_format($booking_details->payment,2); ?></td> 
...
<p class="price" style="  background: #f4f4f4;font-family: lato;font-size: 27px;font-weight: bolder;padding: 58px 9px;text-align: center;margin:0px;">INR <?php echo number_format($booking_details->payment,2); ?> </br>
	<span style="font-size: 12px;">( Please do not disclose the actual price to the guests and payment will be sent to you account by wire transfer )</span>
