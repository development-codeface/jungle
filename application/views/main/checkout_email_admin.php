...
<td style=" border: 1px solid #ccc;padding: 10px;"><?php echo number_format($booking_details->payment+ $commision_price ,2); ?></td> 
...
<p class="price" style="  background: #f4f4f4;font-family: lato;font-size: 27px;font-weight: bolder;padding: 58px 9px;text-align: center;margin:0px;">INR <?php echo number_format($booking_details->payment+ $commision_price ,2); ?> </p>
</div>
