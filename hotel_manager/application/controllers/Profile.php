...
class Profile extends CI_Controller
 {
	 ...
	 function img_del($hot, $val) {
	 $data_image['change_images'] = $this->Profilemodel->details($hot);
	 
	 if($val == 'eng') {
		$old_image =  $data_image['change_images']['engine_bg']->engine_img;
		$eng['engine_img'] = NULL;
	 } else {
		$old_image =  $data_image['change_images']['engine_bg']->offer_img;
		$eng['offer_img'] = NULL;
	 }
					...
					$this->Hotelmodel->update_engine($eng,$hot);
	 }
	...
	public function index()
	{
		...
		if($this->session->userdata['user_type']=='staff')
			...
			$data['opt'] = $this->Hotelmodel->access_options($id);
