...
?>
	<a class="hotel_images_cus" href="<?php echo base_url();?>profile/image_edit/<?php echo $value->hotel_id;?>/<?php echo $value->id;?>">
...
?>
  <form action="<?php echo base_url();?>profile/image_edit/<?php echo $value->hotel_id;?>/<?php echo $image_id;?>" method="post" enctype="multipart/form-data" >
  	
  	
    <div class="change-img_block_cus">
    	  
      <h1 class="uploaded_img_section_title">Change Image</h1>
      <div class="col-sm-12">
      	<p class="hotel_images_cus"><img src="<?php echo base_url().'../'.$change_images[0]->thumb; ?>" width="100" height="100"/></p>
      	<p> <input type="file" name="hotel_image" class=""  /></p>
      	</div>
      	<div class="form-footer-block-cus">
