                            ...
                            <div class="panel-body">
		                            	<div class="row well room_chart_block_cus_color_section">
								                ...
								                <div class="col-lg-12 ">
								                	...
								                	<div class="col-lg-2 room_chart_block_cus_color_section_radio_btn room_chart_block_cus_color_section_radio_btn_available_blocked">
										...
										<div class="form-group">
											<span id="sandbox-container5">
												<input class="col-lg-8 form-control " name="d_month" id="d_month" value="<?php $mon = $this->session->userdata('d_month'); if(empty($mon)) echo date('Y-m'); else echo $mon; ?>" onchange="d_month();">
											</span>
										</div>
									</div>
    ...
    <div class="">
		...
		$start = date($mon.'-01');
		$end = date($mon.'-t', strtotime($start));
		}
