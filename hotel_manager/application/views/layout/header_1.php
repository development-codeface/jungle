    ...
    <div id="wrapper" class="cus_wrapper">
		...
		$logo=$this->db->where('id', $id)->get('tbl_hotel')->row();
			...
			<?php } ?>
					   ...
					   <!--<li class="dropdown">     
				<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bell"></i> <span id="alert_count"><?php echo $book_count;?></span> <b class="caret"></b></a>
                    
					 
						<ul class="dropdown-menu alert-dropdown" id="">
					 <li>
					 <a href="<?php echo base_url(); ?>booking">New Booking <span class="label label-warning"><?php echo $book_count; ?></span></a>
					 </li>
					 </ul>
