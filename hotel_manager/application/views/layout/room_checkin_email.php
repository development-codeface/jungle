...
<p class="tagline" style=" font-family: arial; font-size:23px; font-weight: 400; text-align: right; text-transform: capitalize; margin: 5px;">Travel Easy, Fast and Safe!...</p>
</div>
</div>
</div>
<div class="col-md-12 ">
...
<h6 class="email_user_h" style="color: #44494C;font-family: roboto;font-size: 25px;text-align: center;margin:15px 0px;">Room Checkin</h6>

<p class="email_user_n" style="font-family: roboto;font-weight: 500;">Hi,</p>
<p class="email_cntnt" style="font-family: raleway;font-size: 13px;font-weight: 500;line-height: 25px;">Thank you for choosing to book your rooms from Bookingwings.com.
 </p>
 
 <p class="email_cntnt" style="font-family: raleway;font-size: 13px;font-weight: 500;line-height: 25px;">Your check in has been confirmed from  <?php print_r($hotel_name);?> on <?php print_r($date);?> at <?php print_r($time);?>. 
 </p>
