<html>
<title>Room Check-In | <?php print_r($hotel_name);?></title>
<head>
...
<p class="tagline" style=" font-family: arial; font-size:23px; font-weight: 400; text-align: right; text-transform: capitalize; margin: 5px;"><?php print_r($hotel_name);?></a>
</div>
...
<img src="<?php echo base_url();?>../<?php print_r($hotel_logo);?>">
</div>
...
<h6 class="email_user_h" style="color: #44494C;font-family: roboto;font-size: 25px;text-align: center;margin:15px 0px;">Room Check-In</h6>

<p class="email_user_n" style="font-family: roboto;font-weight: 500;">Hi,</p>
<p class="email_cntnt" style="font-family: raleway;font-size: 13px;font-weight: 500;line-height: 25px;">Thank you for choosing to book your rooms at <?php print_r($hotel_name);?>.
 </p>
 
 <p class="email_cntnt" style="font-family: raleway;font-size: 13px;font-weight: 500;line-height: 25px;">Your check in has been confirmed on <?php print_r($date);?> at <?php print_r($time);?>. 
 </p>
 
  <p class="email_cntnt" style="font-family: raleway;font-size: 13px;font-weight: 500;line-height: 25px;">Hope you have a great vacation and enjoy your stay. Looking forward to be at your assistance throughout the vacation. 
 </p>
...
<div class="email_f_foot" style=" background: #216393; color: #fff;padding: 10px;">
 <p class="addres_f" style="  font-family: raleway;font-size: 13px;font-weight: 500;margin-bottom: 0; margin-top: 20px;  text-align: center;"><?php print_r($hotel_add);?></p>
