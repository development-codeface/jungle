...
<p class="email_cntnt" style="font-family: raleway;font-size: 13px;font-weight: 500;line-height: 25px;">Thank you for choosing to book your rooms from Bookingwings.com. 
 ...
 <p class="email_cntnt" style="font-family: raleway;font-size: 13px;font-weight: 500;line-height: 25px;">Your checkout has been confirmed from  <?php print_r($hotel_name);?> on <?php print_r($date);?> at <?php print_r($time);?>. 
 </p>
