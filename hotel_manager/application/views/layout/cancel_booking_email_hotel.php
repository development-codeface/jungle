...
<p class="tagline" style=" font-family: arial; font-size:23px; font-weight: 400; text-align: right; text-transform: capitalize; margin: 5px;"><?php print_r($hotel);?></a>
</div>
...
<h6 class="email_user_h" style="color: #44494C;font-family: roboto;font-size: 25px;text-align: center;margin:15px 0px;">Your booking was cancelled.</h6>

<p class="email_user_n" style="font-family: roboto;font-weight: 500;">Hi,</p>
<p class="email_cntnt" style="font-family: raleway;font-size: 13px;font-weight: 500;line-height: 25px;">Your booking number : <?php print_r($booking_number);?> had successfully cancelled.
 </p>
...
<div class="email_f_foot" style=" background: #216393; color: #fff;padding: 10px;">
 <p class="addres_f" style="  font-family: raleway;font-size: 13px;font-weight: 500;margin-bottom: 0; margin-top: 20px;  text-align: center;"><?php print_r($add);?></p> 
