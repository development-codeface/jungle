<html>
<title>Room Check-out | <?php print_r($hotel_name);?></title>
<head>
...
<h6 class="email_user_h" style="color: #44494C;font-family: roboto;font-size: 25px;text-align: center;margin:15px 0px;">Room Check-out</h6>
...
<p class="email_cntnt" style="font-family: raleway;font-size: 13px;font-weight: 500;line-height: 25px;">Thank you for choosing to book your rooms at <?php print_r($hotel_name);?>. 
 ...
 <p class="email_cntnt" style="font-family: raleway;font-size: 13px;font-weight: 500;line-height: 25px;">Your checkout has been confirmed on <?php print_r($date);?> at <?php print_r($time);?>. 
 </p>
 
  <p class="email_cntnt" style="font-family: raleway;font-size: 13px;font-weight: 500;line-height: 25px;">Hope you had a great vacation and enjoyed your stay. Looking forward to working with you again. 
 </p>
