                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-fw fa-table"></i> Arrival List
                            </li>
                        </ol>
                        <!-- BreadCrumbs << -->
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-clock-o fa-fw"></i> Todays Arrival list</h3>
                            </div>
		                                ...
		                                if(!empty($results)){
		                                	...
		                                	foreach ($results as $result) {
		                                		if($result->offline_user == 0)
													...
													{
													$booking_details = $this->Bookingmodel->arrival_details($result->booking_number,$id,$date); 
													}
													else
													{
													$booking_details = $this->Bookingmodel->arrival_details_package($result->booking_number,$id,$date); 
													}
												}
												else 
												{
													if($result->category=='hotel')
													{
													$booking_details = $this->Bookingmodel->arrival_details_off($result->booking_number,$id,$date);
													}
													else
													{
													$booking_details = $this->Bookingmodel->arrival_details_off_package($result->booking_number,$id,$date);
													}
												}
		                                    ...
		                                    <tr>
		                                        ...
		                                        <td><a href="<?php echo base_url();?>booking/arrival_detail/<?php echo $result->booking_number.'/'.$result->offline_user.'/'.$result->category;?>">Detail</a></td>
		                                        <!-- <td>
		                                        	<table class="table table-bordered table-hover table-striped">
		                                        		<tr>
		                                        			<td>asd</td>
