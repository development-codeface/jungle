...
<div class="col-lg-1">
		                               			<label>Booking no.</label>
													...
													<div class="form-group col-lg-2">
						                                <button class="btn cus-btn btn-primary" onclick="cancel_num();" >Submit</button>
									                </div>
						                    </div>
						                  </div>
					                 </div>
		                                ...
		                                if(!empty($results)){
		                                	foreach ($results as $result) {
												...
												{ 
													...
													{
													$booking_details = $this->Bookingmodel->cancel_details($result->booking_number,$id);
													}
													else
													{
														$booking_details = $this->Bookingmodel->cancel_details_package($result->booking_number,$id);
													}
												}
												else 
												{
													if($result->category=='hotel')
													{
													$booking_details = $this->Bookingmodel->cancel_details_offline($result->booking_number,$id); 
													}
													else
													{
														$booking_details = $this->Bookingmodel->cancel_details_offline_package($result->booking_number,$id); 
													}
												}
		                                    ...
		                                    <tr>
		                                        ...
		                                        <td><a href="<?php echo base_url();?>booking/cancel_detail/<?php echo $result->booking_number.'/'.$result->offline_user.'/'.$result->category;?>">Detail</a></td>
		                                    </tr>
		                                <?php $i++;
		                                }}
		                                else{
