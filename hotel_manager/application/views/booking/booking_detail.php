		                            		...
		                            		<div class="row well box_border ">
			                            		<div class="col-lg-12 user_details_label ">
													...
													<?php if(!empty($result->agency) && !is_numeric($result->agency)): ?>	<a class="btn btn-success pull-right" href="<?php echo base_url() . 'booking/room_interchange/'.$results[0]->booking_number; ?>" 
														...
														Room Interchange</a><?php endif; </h4>	
		                            		...
		                            		<div class="row well box_border ">
			                            		<div class="col-lg-10 user_details_label ">
								               	...
								               	<div class="list-group col-md-10 col-sm-9   col-xs-9">	
				                            		...
				                            		?>
				                            		 <div class="col-lg-6 amount_cus_block_user_details"><label>Amount : <?php if($result -> package_id == 0) echo '<i class="fa fa-inr"></i> '; else echo '<i class="fa fa-euro"></i> '; echo ($amount) ;?></label></div><?php endif; ?>
				                            		</div>
