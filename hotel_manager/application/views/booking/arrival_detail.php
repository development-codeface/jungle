                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                              ...
                              <li class="">
                                <!-- <i class="fa fa-fw fa-table"></i>  --><a href="<?php echo base_url();?>booking/arrival">Arrival List </a>
                            </li>
                          
                             <li class="active">
                                <!-- <i class="fa fa-fw fa-table"></i> -->Arrival detail view
                            </li>
                        </ol>
                        <!-- BreadCrumbs << -->
                    </div>
                    ...
                    <div class="col-lg-12 ">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                               <i class="fa fa-eye"></i> Arrival Detail View
                            ...
                            <div class="panel-body">
                                <div class="col-md-12">
                                 <div class=" space_cus_user_details">
		                            ...
		                            <div class=" cus_user_block2">
		                            		<div class="row well box_border">
			                            		<div class="col-lg-12 user_details_label ">
				                            		<h4 class="page-header cus_header" style="margin : 0px;">
								                    	<label><?php //echo $result['package_data'][0]->title;?> <span class="bncus">Booking No:</span> <span class="bncusn"><?php echo $results[0]->booking_number;?></span></label>
															<?php if(!empty($result->agency) && !is_numeric($result->agency)): ?><a class="btn btn-success pull-right" href="<?php echo base_url() . 'booking/room_interchange/'.$results[0]->booking_number; ?>" 
														onclick="javascript&#58;window.open(this.href, this.target, 'width=600,height=600,screenX=400,screenY=100,resizable,scrollbars');return false;">
														Room Interchange</a>
			                            		...
			                            		<div class="list-group ">	
						                         	...
						                         	<div class="col-md-4  user_details_block_cus_booking_page  user_details_blockmj">
						                        <div class="col-lg-12">
						                             ...
						                             <div class="col-lg-4">Country</div>
				                            			<div class="col-lg-1 cus_column_block"> :</div>
							                      		<div class="col-lg-6" style="word-wrap:break-word;"><?php echo $results[0]->country;?></div>
													               	...
													               	<div class="col-md-4  user_details_block_cus_booking_page  user_detailskj_block">
						                        <div class="col-lg-12 user_detpailskj_block">
													<div class="guest_detailsb"> 
				                            		...
				                            		<div class="col-md-3  pull-right user_details_block_cus_booking_page">
				                            		...
				                            		<div class="col-lg-12 booking_details_cus">
						                             <div class="col-lg-5">Booked Via</div>
				                            			<div class="col-lg-1 cus_column_block"> :</div>
							                      		<div class="col-lg-5" style="word-wrap:break-word;"><b><?php echo $results[0]->agency ; ?> (Channel)</b></div>
				                            		</div>
				                            		<?php 
													$payment = $results[0]->advance+$results[0]->payment;
													} else if(!empty($results[0]->agency)) {?>
				                            		<div class="col-lg-12 booking_details_cus">
						                             <div class="col-lg-5">Booked Via</div>
				                            			<div class="col-lg-1 cus_column_block"> :</div>
													...
													$payment = $results[0]->advance+$results[0]->payment;
						                             ...
						                             <div class="col-lg-5">Booked Via</div>
				                            			<div class="col-lg-1 cus_column_block"> :</div>
							                      		<div class="col-lg-5" style="word-wrap:break-word;"><b>bookingwings.com, online</b></div>
				                            		</div>
			                            		...
			                            		<div class="col-lg-12 booking_details_cus">
						                             <div class="col-lg-5">Status</div>
				                            			<div class="col-lg-1 cus_column_block"> :</div>
							                      		<div class="col-lg-5"><b><?php if($results[0]->status=='0') { echo "Room Blocked"; } if($results[0]->status=='1') { echo "Room Reserved" ;}?></b></div>
				                            		</div>
		                            		...
		                            		<div class="row well box_border box_border_cus_arrival_details_block guest_detailsbmarrival_details">
			                            		<div class="col-lg-12 user_details_label ">
								                 ...
								                 <label><?php //echo $result->room_title;?></label>
								                    	<?php   if($j==1)
													{?>
														 <a id="checkin_user_details" class="pull-right  cus_chk_in_same_user_details">Checkin as same user details</a>
													<?php }?>
								                    </h4>
								                </div> 
								               	<div class="list-group">	
												...
												<div class="col-lg-12">
				                            		...
				                            		?>
				                            		 <div class="col-lg-8 amount_cus_block_user_details"><label>Amount : <?php if($result -> package_id == 0) echo '<i class="fa fa-inr"></i> '; else echo '<i class="fa fa-euro"></i> '; echo $amount;?></label></div><?php endif; ?>
				                            		</div>
				                            	...
				                            	foreach($room_number as $booking_rooms)
				                            	{
												 ...
												 ?>     
				                            		<form class="checkin_form col-md-12"	>
								              ...
								              <input placeholder="Name" name="name" id="name<?php echo $booking_rooms->booking_room_id;?>" class="col-lg-8 form-control username" 
						                       value="<?php if(!empty($check_user_checkin)): echo $check_user_checkin[0]->name; endif;?>">
						                      </div>
						                      <div class="form-group col-lg-4">
						                      	<label class="cus_booked_room_status"></label>
						                        <input placeholder="Email ID"name="email_id" id="email_id<?php echo $booking_rooms->booking_room_id;?>" 
						                         value="<?php if(!empty($check_user_checkin)): echo $check_user_checkin[0]->email; endif;?>" class="col-lg-8 form-control useremail">
						                      </div>
						                      <div class="form-group col-lg-3">
						                      	<label class="cus_booked_room_status"></label>
						                       <input placeholder="Ph.No" name="phone_no" id="phone<?php echo $booking_rooms->booking_room_id;?>"
						                        value="<?php if(!empty($check_user_checkin)): echo $check_user_checkin[0]->phone; endif;?>"  class="col-lg-8 form-control userphone">
						                      </div>
						                     <div class="form-group  col-lg-2">
						                     	<label class="cus_booked_room_status"></label>
										      <button name="room_sub" class="btn cus-btn btn-primary" type="button" id="checkin<?php echo $booking_rooms->booking_room_id;?>" 
										      onclick="room_checkin('<?php echo $booking_rooms->booking_room_id;?>','<?php echo $result->booking_id;?>');" 
										      <?php if(!empty($check_user_checkin)):?> disabled='' <?php endif;?>>Checkin</button>
			                            		...
			                            		<div class="col-lg-12 user_details_label ">
								               	...
								               	<div class="list-group">	
				                            		...
				                            		<div class="col-lg-12">
				                            		 ...
				                            		 <div class="col-lg-6 amount_cus_block_user_details"><label>Amount : if($result -> package_id == 0) echo '<i class="fa fa-inr"></i> '; else echo '<i class="fa fa-euro"></i> ';<?php echo ($foodplan[0]->amount) ;?></label></div>
				                            		</div>
													</div>
			                            		</div>
		                            		...
		                            		<div class="row well box_border box_border7">
												...
												<div class=" col-md-12 ">
								               	...
								               	<div class="list-group col-md-6">	
													...
													<label>Tax : <?php if($result -> package_id == 0) echo '<i class="fa fa-inr"></i> '; else echo '<i class="fa fa-euro"></i> '; echo $result->tax;?></label> 
													...
													<div class="col-lg-4"><label>Agency Commision : <?php echo $result->commision;?></label> </div></div>
													
													<?php $total_amount = $total_amount - $result->commision;
													}
													}
													
													if(!empty($result->agency) && !is_numeric($result->agency)):
													...
													<div class=" col-md-12 amount_section_cus_block">
				                            				<b>You need to ensure the following at check-in :</b>
				                            					<p>Guest holds hotel voucher with correct reservation details and a valid photo ID.</p>	
				                            	...
				                            	<div class="col-lg-12 ">
														...
														<?php if(!empty($result->discount)){?>
				                            			<div class="col-lg-12 total_amount_label_cus"><label>Discount : if($result -> package_id == 0) echo '<i class="fa fa-inr"></i> '; else echo '<i class="fa fa-euro"></i> ';<?php echo ($result->discount);?></label> </div>
														<?php 
														}
