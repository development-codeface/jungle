                    ...
                    <div class="col-lg-12 ">
                            ...
                            <div class="panel-body">
                                 ...
                                 <div class="col-md-12 space_cus_user_details">
				                    ...
				                    <div class="col-lg-10" id="msg_div">
										...
										<?php  if(!empty($results[0]->agency)){ ?>	 <div class="form-group col-lg-2">
											</div>
					  ...
					  <input type="hidden" name="book_num" id="book_num" value="<?php echo $results[0]->booking_number;?>"/>
					   ...
					   <div class="form-group col-lg-2">
                                ...
                                $total_amount=0;
								$j=1;
								if($results[0]->offline_user != 0) {
									?>
									
									<a class="btn btn-success" href="<?php echo base_url().'booking/room_type/'.$results[0]->booking_number; ?>">Add room</a><?php }
