                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                              ...
                              <li class="">
                                <!-- <i class="fa fa-fw fa-table"></i>  --><a href="<?php echo base_url();?>booking/checkout_list">Checkout List </a>
                            </li>
                          
                             <li class="active">
                                <!-- <i class="fa fa-fw fa-table"></i> -->Checkout detail view
                            </li>
                        </ol>
                        <!-- BreadCrumbs << -->
                    </div>
                    ...
                    <div class="col-lg-12 ">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                               <i class="fa fa-eye"></i> Checkout Detail View
		                            		...
		                            		<div class="row well box_border box_border7">
												...
												<div class="col-md-6">
								               	<div class="list-group">	
													...
													<div class="col-lg-12"><div class="col-lg-12"><label>Tax : <?php echo $result->tax;?></label> </div></div>
													</div>
