					...
					<div class="form-group col-lg-6">
					 ...
					 <div class="form-group col-lg-6">
                      ...
                      <div class="form-group col-lg-3">
                        ...
                        <input class="col-lg-12 form-control " name="validity_from" id="validity_from" <?php echo set_value('validity_from'); ?>>
                        </span>
                      ...
                      <div class="form-group col-lg-3">
                        ...
                        <input class="col-lg-12 form-control " name="validity" id="validity" value="<?php echo set_value('validity'); ?>">
                        </span>
                     ...
                     <!-- <div class="form-group col-lg-6 marg_cus">
                        ...
                        <div class="col-lg-12" style="padding-left: 0; padding-right: 0;">
                        <textarea class="ckeditor" rows="3" name="services" id="services"></textarea>
                        </div>
                      </div>-->
