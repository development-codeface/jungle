...
<div id="page-wrapper">
									...
									<div class="col-lg-2">
										<div class="form-group">
											<span id="sandbox-container-cin">
												<input class="col-lg-8 form-control" name="from" id="from" onchange="get_dates_online()" value="<?php if(!empty($from)) echo $from; ?>">
											</span>
										</div>
									</div>
									<div class="col-lg-1">
									...
									<div class="col-lg-2">
										<div class="form-group">
											<span id="sandbox-container-cout">
												<input class="col-lg-8 form-control" name="to" id="to" onchange="get_dates_online()" value="<?php if(!empty($to)) echo $to; ?>">
											</span>
										</div>
									</div>
			...
			$total+=$b_total -> total_amount+$b_total -> tax;  } }
                            		if(!empty($total)) {?><p class="text-right">Total - <?php echo $total; ?></p><?php } ?>
		...
		<tbody>
			...
			<tr>
				...
				<td><?php echo $booking -> total_amount+$booking -> tax; ?></td>
			</tr>
